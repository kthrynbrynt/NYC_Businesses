...
#Make Industry into a factor
DCA$Industry = as.factor(DCA$Industry)


#Define variables that will be used by the ui, the server, or both
...
#Added a column of icon names in case different licenses were going to be 
#displayed and differentiated by icon; didn't use in the end.
...
#Wanted to provide little informational blurbs about each license; got the info myself from the
#web and created new data frame consisting of the industry levels from the above DCA data frame
#and a character vector, Descriptions, of equal length that contains the blurbs.
...
#Both icons and icons_added contain the code that makes the markers on my  
#maps look how they do. 
